...
# ╔═╡ e9f5f672-17b6-11ec-1068-9550ba0e8544
using Javis, LinearAlgebra, Animations

# ╔═╡ 30f9d53e-c0cb-401c-9ab2-ef4f7d5c622b
function ground(args...)
	background("white")
	sethue("black")
end

# ╔═╡ 424c3e18-832a-467d-8559-97f2e07b054a
function draw_spring(A, B, num_peaks, width, gap)
...
# ╔═╡ 2d812d49-d41b-4664-852e-3aea2dffb540
...
# ╔═╡ 0c71a8cc-5e48-4a55-a5ac-d1a128de0298
begin
	...
	ball1 = Object(1:frames, (args...) -> object(O, "red"), Point(-100, 0))	
	ball2 = Object(1:frames, (args...) -> object(O, "red"), Point(100, 0))	
	...
	act!(ball1, Action(1:frames, tfwd, translate()))
	act!(ball2, Action(1:frames, tbwd, translate()))
	Object(1:frames, (args...)->draw_spring(pos(ball1), pos(ball2), 20, 30, 25))
